...
get_header(); ?>
  	...
  	<div role="main">   	 
	    ...
	    <div class="col-sm-12">      	
		    <div class="row">
			  	<?php 
				    $posts = get_children('orderby=menu_order&order=asc&post_parent=1187&post_status=publish');
				    foreach ($posts as $post): setup_postdata($post);                	
			    ?>       
			  	<div class="col-sm-12 minha_borda">			  			
						<div class="col-sm-4" style="padding: 10px;">        			       
							<img src="<?php echo get_the_post_thumbnail_url(null, array(115, 115)) ?>" class="img-responsive fotos_politicos">							
						</div>
						<div class="col-sm-8" style="margin-right: -20px !important; padding: 10px;">
							<?php 
    ...
    <div class="fundo_politicos col-sm-12">
	   <!-- <div class="row">
	    ...
	    <div class="row minha_borda">			    	
		    ...
		    <div class="col-sm-12">
	    		<?php echo "<div id='campo-personalizado' style='padding: 10px 15px; mrgin: 0px; margin-bottom: 20px; text-decoration: none; list-style: none; width: 100%; border-radius: 7px; border: 1px solid #ccc; box-sizing: border-box;'>"; ?>
	    		<?php the_meta(); ?>
