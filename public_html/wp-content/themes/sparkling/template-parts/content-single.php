<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	...
	<div class="post-inner-content">
		...
		<div class="entry-content">		
			...
			<?php the_content(); ?>							
			<div id="campo-personalizado" style="padding: 10px 15px; margin: 0px; text-decoration: none; list-style: none; width: 100%; border-radius: 7px; border: 1px solid #ccc; box-sizing: border-box; background-color: #dcdcdc;">
				<?php the_meta(); ?>
