...
get_header(); ?>
    ...
    <div role="main">      
      ...
      <div class="col-sm-12">       
        <div class="row">
          <?php 
            $posts = get_children('orderby=menu_order&order=asc&post_parent=1287&post_status=publish');
            foreach ($posts as $post): setup_postdata($post);                 
          ?>       
          <div class="col-sm-12 minha_borda">             
            <div class="col-sm-3" style="padding: 10px;">                    
              <img src="<?php echo get_the_post_thumbnail_url(null/*, array(115, 115, true)*/) ?>" class="img-responsive fotos_politicos thumb_page">        
            </div>
