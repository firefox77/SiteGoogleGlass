<!-- Footer -->
  ...
  <section class="copyright py-4 text-center text-white">
    <div class="container">
      <small>Copyright &copy; <a href="https://www.wvtodoz.com.br/" target="_blank" style="text-decoration: none;">WV_TODOZ</a></small>
    </div>
  </section>
  ...
  <script src="<?php echo get_stylesheet_directory_uri(); ?>/assets/js/freelanncer.min.js"></script>
