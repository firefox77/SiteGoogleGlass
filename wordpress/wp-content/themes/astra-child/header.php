...
<html lang="en">
  <head>  
    ...
    <title>SUPORTE TÉCNICO WV</title>

    <!-- Custom fonts for this theme -->
    <link href="<?php echo get_stylesheet_directory_uri(); ?>/assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link href="<?php echo get_stylesheet_directory_uri(); ?>/assets/vendor/fontawesome-free/css/all.min.css" rel="stylesheet" type="text/css">
    <link href="https://fonts.googleapis.com/css?family=Lato:400,700,400italic,700italic" rel="stylesheet" type="text/css">

    <!-- Theme CSS -->  
    <link href="<?php echo get_stylesheet_directory_uri(); ?>/assets/css/freelancer.min.css" rel="stylesheet">
    <?php wp_head(); ?>
  </head>
  ...
  <body id="page-top">
    ...
    <header class="masthead bg-primary text-white text-center">
      <div class="container d-flex align-items-center flex-column">
        ...
        <img class="masthead-avatar mb-5" src="<?php echo get_stylesheet_directory_uri(); ?>/assets/img/suporte_wv.png" alt=""> 

        <!-- Masthead Heading -->
        <h1 class="masthead-heading text-uppercase mb-0">ATENDIMENTO <font style="color: #c0f500;">WV_</font>TODOZ</h1>
        ...
        <!-- Masthead Subheading -->
        <p class="masthead-subheading font-weight-light mb-0">Facíleme & Let's Work </p>
